				...
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							...
							<li class="menu-item home current-menu-item"><a href="productsAndroid.php">Android</a></li>
				...
				<div class="container">
						...
						<div class="product-list">
							<?php $db=mysqli_connect("localhost","root","","jeux");
								$sql="SELECT * FROM jeux_video WHERE console='Android'";
