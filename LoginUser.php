...
$id=$_GET['id'];
$prix=$_GET['prix'];
header('Location: inscritTerm.php?id='.$id.'&prix='.$prix);
}
?>
<!DOCTYPE html>
<html lang="en">
...
<main class="main-content">
	<div class="container">
	<div class="page">
	<h2 class="section-title">Login Client</h2>
					<form method="post" action="verif2.php" enctype="multipart/form-data" >
						<input type="text" placeholder="Username..." name="id"><br><br>
						<input type="password" placeholder="Password..." name="pswd"><br><br>
						<input type="submit" value="Login" name="login"><br>
						<a href="inscrit.php">Creat your account !</a>
					</form>
	</div>
	</div>
		</main>
