...
<html lang="en">
	<head>
		...
		<title>Game Zone | Playstation</title>
				...
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							...
							<li class="menu-item home current-menu-item"><a href="productsPS.php">Playstation</a></li>
				...
				<div class="container">
						...
						<div class="product-list">
							<?php $db=mysqli_connect("localhost","root","","jeux");
								$sql="SELECT * FROM jeux_video WHERE console='Playstation'";
